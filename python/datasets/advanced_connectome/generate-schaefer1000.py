...
print("Fetching Schaefer 2018 1000-node parcellation...")
dataset = datasets.fetch_atlas_schaefer_2018(n_rois=1000, resolution_mm=2)
...
n_long = int(0.04 * 1000 * 1000)
rows = rng.integers(0, 1000, size=n_long)
cols = rng.integers(0, 1000, size=n_long)
...
cmd = [
    ...
    "--name", "Schaefer 1000 Synthetic",
    "--description", "Advanced 1000-region cortical parcellation (Schaefer et al. 2018) with synthetic small-world connectivity based on MNI coordinates.",
    "--backend", "rate_based"
]
