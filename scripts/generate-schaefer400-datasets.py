...
MODELS = [
    {
        ...
        "n_tp": 600,      # Generate a shorter run for 400 regions to save time (600 TRs)
        "sessions": 2,    # Just 2 sessions
        "lambda_bold": 10,
        "networks": {
            "Visual":      list(range(0, 58)),
            "SomMot":      list(range(58, 115)),
            "DorsAttn":    list(range(115, 172)),
            "SalVentAttn": list(range(172, 229)),
            "Limbic":      list(range(229, 286)),
            "Cont":        list(range(286, 343)),
            "Default":     list(range(343, 400)),
        },
    },
]
